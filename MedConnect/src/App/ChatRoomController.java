...
public class ChatRoomController implements Initializable {
    ...
    private boolean isRightAlign = true;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Platform.runLater(() -> {
            try {
                ...
                if (messages.isEmpty()) {
                    addSystemMessage("Selamat datang di Chat Room MedConnect! Mulai percakapan Anda.");
                }
    ...
    private void addSystemMessage(String content) {
        try {
            ...
            addMessageToUI(systemMsg, false); 
