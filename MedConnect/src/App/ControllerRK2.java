...
public class ControllerRK2 {
    ...
    public void initialize() {
        addDoctorMessage("Selamat datang! Saya dr. Rina Astuti. Ada yang bisa saya bantu?");
    }
    ...
    private void handleKirimJadwal() {
        NotificationManager.addNotification("📅 Anda menerima jadwal kontrol baru dari dr. Rina Astuti.");
    ...
    private void addDoctorMessage(String text) {
        Label label = new Label("👨‍⚕️ dr. Rina Astuti:\n" + text);
