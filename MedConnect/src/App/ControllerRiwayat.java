...
public class ControllerRiwayat {
    ...
    @FXML
    private TextField fieldTanggal;  // Changed from DatePicker to TextField
    ...
    private ArrayList<RiwayatPasien> riwayatArrayList;  // Added ArrayList
    ...
    public void initialize() {
        ...
        // Sync ArrayList with ObservableList
        syncArrayListWithObservableList();
        
        // Set default date to today (manual format)
