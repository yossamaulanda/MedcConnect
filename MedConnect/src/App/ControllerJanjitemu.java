...
public class ControllerJanjitemu {
    ...
    private JanjiTemuManager janjiTemuManager; // Reference ke manager
    
    public void initialize() {
        // Gunakan JanjiTemuManager sebagai sumber data
        ...
        // Setup data - Load dari manager
        loadDataFromManager();
        filteredJanjiTemu = new ArrayList<>(daftarJanjiTemu);
        updateStats();
        displayJanjiTemu();
        
        // Add listener untuk real-time filter saat combo berubah
    ...
    // Method untuk load data dari manager
    ...
    private void updateStats() {
        // Gunakan data dari manager untuk stats yang lebih akurat
    ...
    private HBox createJanjiTemuBox(JanjiTemu janji) {
        ...
        keluhanLabel.setWrapText(true); // Wrap text untuk keluhan panjang
        ...
        // Status dengan indikator visual yang lebih baik
    ...
    // Style yang lebih baik untuk status
    ...
    private void handleRefresh(ActionEvent event) {
        // Refresh dari manager untuk mendapatkan data terbaru
        loadDataFromManager();
        filteredJanjiTemu = new ArrayList<>(daftarJanjiTemu);
        updateStats();
        displayJanjiTemu();
    ...
    // Handler untuk button actions jika ada di FXML
    @FXML
