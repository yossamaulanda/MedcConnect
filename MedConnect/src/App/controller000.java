...
public class controller000 implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // Initially hide doctor name field (not needed for any role now)
    ...
    private void handleRoleChange(ActionEvent event) {
        ...
        // Hide doctor name field for all roles (no longer needed)
        txtDokterName.setVisible(false);
        labelDokter.setVisible(false);
        txtDokterName.clear();
        
        // Add animation to role change
        animateRoleChange();
    }
    ...
    private void handleRegisterButton(ActionEvent event) {
        ...
        // Re-enable button after successful registration (though user will be redirected)
        registerButton.setDisable(false);
    }
    ...
    private void directToHalaman0() {
        try {
            ...
            Pane page = openScene.getPane("halaman00.fxml");
            
            // Add transition animation
            addPageTransition(page);
            
            mainPane.setCenter(page);
            System.out.println("Redirected to halaman00 page");
        } catch (Exception e) {
            showStyledAlert(AlertType.ERROR, "Navigation Error", "Could not load Halaman0 page: " + e.getMessage());
        }
    }
    ...
    private void directToLogin() {
        try {
            ...
            showStyledAlert(AlertType.ERROR, "Navigation Error", "Could not load login page: " + e.getMessage());
        }
    }

    // NEW METHOD: Direct to halaman1.fxml after successful registration
    ...
    private void registerDokterUser(String name, String username, String email, String password, String usia) {
        ...
        // Redirect to halaman1.fxml instead of login
        directToHalaman1();
    }
    ...
    private void addFocusEffects() {
        // Add focus effects to all text fields
