...
public class ControllerRK3 {
    ...
    public void initialize() {
        addDoctorMessage("Selamat datang! Saya dr. Andi Wijaya. Ada yang bisa saya bantu?");
    }
    ...
    private void handleKirimJadwal() {
        NotificationManager.addNotification("📅 Anda menerima jadwal kontrol baru dari dr. Andi Wijaya.");
    ...
    private void addDoctorMessage(String text) {
        Label label = new Label("👨‍⚕️ dr. Andi Wijaya:\n" + text);
